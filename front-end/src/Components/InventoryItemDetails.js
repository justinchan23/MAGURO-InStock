...
const InventoryItemDetails = ({ itemDetails, editToggle }) => {
  let stock = 'In Stock'
  ...
  return (
    <div className="iid">
      <div className="iid__one">
        ...
        <h2 className="iid__one__title">{itemDetails.name}</h2>
      ...
      <div className="iid__desk">
        <div className="iid__two">
          ...
          <p className="iid__info__two">{itemDetails.long_description}</p>
        </div>
        <div>
          <div className="iid__info__chunk">
            <div className="iid__block">
              <div className="iid__sub">
                ...
                <p className="iid__info">{itemDetails.ordered_by}</p>
              </div>
              <div>
                <h4 className="iid__header">LAST ORDERED</h4>
                <p className="iid__info">{itemDetails.last_ordered}</p>
              </div>
            </div>
            <div className="iid__block">
              <div className="iid__sub">
                <h4 className="iid__header">REFERENCE NUMBER</h4>
                <p className="iid__info">{itemDetails.reference_number}</p>
              </div>
              <div>
                <h4 className="iid__header">LOCATION</h4>
                <p className="iid__info">{itemDetails.location}</p>
              </div>
            </div>
          </div>
            ...
            <div className="iid__sub">
              <div className="iid__block">
                <div className="iid__sub">
                  ...
                  <p className="iid__info">{itemDetails.quantity}</p>
                </div>
              </div>
              <h4 className="iid__header">CATEGORIES</h4>
              <p className="iid__info">{itemDetails.categories}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="iid__block__button">
        <button className="iid__button" onClick={() => editToggle()}>
          EDIT
        </button>
      </div>
    </div>
